...
if(await exists(assetsDir)){ const assets=await readdir(assetsDir); expect(assets.includes('routine-scroll-poster.jpg'),'Missing routine poster.'); expect(assets.includes('routine-forward.mp4'),'Missing forward routine video.'); expect(assets.includes('routine-reverse.mp4'),'Missing reverse routine video.'); expect(assets.includes('footer-waves.svg'),'Missing footer wave pattern.'); expect(assets.includes('closing-wave.svg'),'Missing Home closing wave.'); expect(assets.includes('avokind-wordmark-clean.png'),'Missing AvoKind wordmark.'); }
